...
%Converted the resource manager to be generic and to use smart pointers
	...
	\lstinputlisting[style=C++, label={lst:implementation1}, caption={Resource Manager generic load function}, firstline=1, lastline=19]{codeSamples/implementation.cpp}
